...
OUT_DIR   = Path('그래프 파일 저장 경로 입력')
MODEL_DIR = Path('모델 파일 저장 경로 입력')
MODEL_DIR.mkdir(exist_ok=True)

N_TRIALS = 50   # Optuna 탐색 횟수 (늘릴수록 정확하나 시간 증가)
CV_FOLDS = 3    # 튜닝 중 사용할 CV fold 수
...
save_path = MODEL_DIR / 'spam_V2.pkl'
